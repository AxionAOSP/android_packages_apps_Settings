...
class PowerModeTileService : TileService() {
    ...
    companion object {
        ...
        private const val DEVICE_POWER_MODE_BY_USER_KEY = "power_mode_perf_by_user"
    }
    ...
    private fun togglePowerMode() {
        ...
        contentResolver?.let {
            ...
            Settings.System.putIntForUser(it, DEVICE_POWER_MODE_BY_USER_KEY, newModeValue.toInt(), UserHandle.USER_CURRENT)
        }
